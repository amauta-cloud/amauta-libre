...
export const en: typeof es = {
  ...
  onboarding: {
    ...
    siguiente: 'Next →',
    empezar: 'Get started',
    step0_title: 'How does Amauta work?',
    step0_desc: 'Four main sections: Dashboard, Planning, Learning, and Settings. The next steps show you what each one does.',
    step1_title: 'Dashboard has 5 tabs',
    step1_desc: '⚡ Today · 💰 Finances · 📊 Month · ✏️ Habits · 🎯 Goals. Each has its moment. We\'ll walk you through the main ones.',
    step2_title: 'Today: the core of everything',
    step2_desc: 'Check off your habits, log income and expenses, and close the day seeing how it went. Your streak 🔥 grows every time you follow through.',
    step3_title: 'Finances: every dollar tracked',
    step3_desc: 'Log income and expenses by category. When money comes in, the app suggests setting aside 10% as investment. Each month, you see where everything went.',
    step4_title: 'Planning has 3 tabs',
    step4_desc: '💡 Ideas: whatever comes to mind. ✅ Tasks: with due date and status. 📅 Calendar: everything together, sorted by date.',
    step5_title: 'Learning: 11 steps',
    step5_desc: 'A path to work on your mindset. No deadline. You move when you want, at the pace you can.',
    step6_title: 'Your goal, always in sight',
    step6_desc: 'What you wrote when you started shows up here every day. On the hard days, it\'s what reminds you why.',
  },
}
