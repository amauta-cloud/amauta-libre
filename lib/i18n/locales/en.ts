...
export const en: typeof es = {
  ...
  onboarding: {
    ...
    siguiente: 'Next →',
    empezar: 'Get started',
    step0_title: 'Your dashboard',
    step0_desc: 'Everything you\'ll work on is here: habits, finances, goals, tasks. You don\'t need to touch everything on day one. Start with whatever pulls you in.',
    step1_title: 'Today tab is your home base',
    step1_desc: 'Here you mark what you completed, log income and expenses, and see how the day closed. It doesn\'t have to be perfect. It has to be yours.',
    step2_title: 'The habits are yours',
    step2_desc: 'There are templates ready to use, but you can add the ones you want to work on. The system adapts to what you need, not the other way around.',
    step3_title: 'Two quick links at the top',
    step3_desc: 'Your tasks and ideas are in Planning. The books and audio from the journey are in Education. You move when you want, at the pace you can.',
    step4_title: 'Your goal, always in sight',
    step4_desc: 'What you wrote shows up here every day. Not to pressure you. So that on the hard days you don\'t lose sight of why you\'re doing this.',
  },
}
