...
export const en: typeof es = {
  ...
  onboarding: {
    ...
    siguiente: 'Next →',
    empezar: 'Get started',
    step0_title: 'Everything is here',
    step0_desc: 'Habits, finances, goals, tasks — all in one place. You don\'t need to touch everything on day one. Start with whatever pulls you in.',
    step1_title: 'The day at a glance',
    step1_desc: 'Each day you check off what you did and log what moved money-wise. At the end you see how it went. No fluff.',
    step2_title: 'The habits are yours',
    step2_desc: 'There are templates ready to use. Add the ones you actually want to work on: with specific days, a number goal, and whatever category fits.',
    step3_title: 'Tasks and ideas',
    step3_desc: 'Planning holds your tasks with due dates and the loose ideas that come to you. Learning has 11 steps to work your mindset.',
    step4_title: 'Your goal, always in sight',
    step4_desc: 'What you wrote shows up here every day. On the hard days, it\'s what reminds you why you started.',
    step5_title: 'Your money, in order',
    step5_desc: 'Track income and expenses by category. When money comes in, the app suggests setting aside 10% as investment. At month end, you see where every dollar went.',
  },
}
