...
export const pt: typeof es = {
  ...
  onboarding: {
    ...
    siguiente: 'Próximo →',
    empezar: 'Começar',
    step0_title: 'Como funciona o Amauta?',
    step0_desc: 'Quatro seções principais: Painel, Planejamento, Aprendizado e Configurações. Os próximos passos mostram o que cada uma faz.',
    step1_title: 'O Painel tem 5 abas',
    step1_desc: '⚡ Hoje · 💰 Finanças · 📊 Mês · ✏️ Hábitos · 🎯 Metas. Cada uma tem seu momento. Vamos mostrar as mais importantes.',
    step2_title: 'Hoje: o núcleo de tudo',
    step2_desc: 'Você marca os hábitos que cumpriu, registra receitas e gastos, e fecha o dia vendo como foi. Sua sequência 🔥 sobe cada vez que você cumpre.',
    step3_title: 'Finanças: cada real no lugar',
    step3_desc: 'Registre receitas e despesas por categoria. Quando entra dinheiro, o app sugere separar 10% como investimento. Cada mês, você vê onde tudo foi parar.',
    step4_title: 'Planejamento tem 3 abas',
    step4_desc: '💡 Ideias: o que vem à mente. ✅ Tarefas: com data e status. 📅 Calendário: tudo junto, por data.',
    step5_title: 'Aprendizado: 11 passos',
    step5_desc: 'Um caminho para trabalhar sua mentalidade. Sem prazo. Você avança quando quiser, no ritmo que puder.',
    step6_title: 'Sua meta, sempre à vista',
    step6_desc: 'O que você escreveu ao entrar aparece aqui todos os dias. Nos dias difíceis, é o que te lembra por que começou.',
  },
}
