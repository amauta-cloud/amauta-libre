...
export const pt: typeof es = {
  login: {
    ...
    error_oauth: 'Não foi possível conectar ao Google. Tente novamente.',
  ...
  educacion: {
    ...
    llegaste: '🏆 Você terminou tudo.',
    once_materiales: '16 materiais. 16 reflexões próprias. Muito poucas pessoas chegam até aqui.',
  ...
  onboarding: {
    ...
    siguiente: 'Próximo →',
    empezar: 'Começar',
    step0_title: 'Dois minutos e você sabe o caminho',
    step0_desc: 'Três seções. Painel é onde o dia a dia acontece. Planejamento guarda suas tarefas e ideias. Aprendizado é pra trabalhar como você pensa.',
    step1_title: 'Hoje. Onde cada dia começa.',
    step1_desc: 'Vem aqui cada manhã, marca seus hábitos, fecha o dia. Aparece e a sequência 🔥 sobe. Falta um dia e volta pra zero.',
    step2_title: 'Finanças. Veja onde vai cada centavo.',
    step2_desc: 'Anote receitas e despesas por categoria. Entra dinheiro e aparece um aviso pra reservar 10% como investimento. No fim do mês, você vê o quadro completo.',
    step3_title: 'Hábitos. O que você quer manter.',
    step3_desc: 'Adicione hábitos aqui e eles aparecem em Hoje pra marcar cada dia. Crie os seus ou escolha da lista. A sequência não mente.',
    step4_title: 'Metas. Por que você está fazendo isso.',
    step4_desc: 'A meta que você escreveu ao entrar fica aqui, visível todo dia. Nos dias difíceis, leia.',
    step5_title: 'Planejamento',
    step5_desc: 'Ideias, tarefas com data e um calendário em um lugar. O que não é hábito diário vai aqui. Está na barra de navegação.',
    step6_title: 'Aprendizado',
    step6_desc: '16 livros, áudios e vídeos, cada um com um exercício de reflexão. Sem cronograma. Avance quando quiser. Está na barra de navegação.',
    push_title: 'Mantenha a sequência viva',
    push_desc: 'Um aviso às 8 da manhã e outro à noite pra fechar o dia. Mude quando quiser no seu perfil.',
