export const es = {
  ...
  onboarding: {
    ...
    siguiente: 'Siguiente →',
    empezar: 'Arrancar',
    step0_title: '¿Cómo funciona Amauta?',
    step0_desc: 'Cuatro secciones principales: Tablero, Planificación, Aprendizaje y Configuración. En los próximos pasos te mostramos qué hace cada una.',
    step1_title: 'El Tablero tiene 5 pestañas',
    step1_desc: '⚡ Hoy · 💰 Finanzas · 📊 Mes · ✏️ Hábitos · 🎯 Metas. Cada una tiene su momento. Te explicamos las más importantes.',
    step2_title: 'Hoy: el núcleo de todo',
    step2_desc: 'Acá marcás los hábitos que cumpliste, anotás ingresos y gastos, y cerrás el día viendo cómo te fue. La racha 🔥 sube cada vez que cumplís.',
    step3_title: 'Finanzas: cada peso, en orden',
    step3_desc: 'Registrás ingresos y gastos por categoría. Si entra plata, la app te propone apartar el 10% como inversión. Al mes, ves un análisis completo.',
    step4_title: 'Planificación tiene 3 pestañas',
    step4_desc: '💡 Ideas: lo que se te ocurre. ✅ Tareas: con fecha y estado. 📅 Calendario: todo junto, ordenado por fecha.',
    step5_title: 'Aprendizaje: 11 pasos',
    step5_desc: 'Un camino para trabajar tu mentalidad. Sin fecha límite. Avanzás cuando querés, al ritmo que podés.',
    step6_title: 'Tu meta, siempre a la vista',
    step6_desc: 'Lo que escribiste al entrar aparece acá todos los días. En los días difíciles, es lo que te recuerda por qué arrancaste.',
  },
}
