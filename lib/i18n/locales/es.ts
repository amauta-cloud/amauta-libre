export const es = {
  ...
  onboarding: {
    ...
    step1_desc: 'Acá empezás cada mañana. Marcás los hábitos que cumpliste, anotás lo que entrò y salió, y cerrás el día. Cada día que te presentás, la racha 🔥 sube.',
    step2_title: 'Hábitos — lo que querés sostener',
    step2_desc: 'Los hábitos que cargues acá aparecen en la pestaña Hoy para marcarlos todos los días. Podés crear los tuyos o elegir de la lista. La racha mide qué tan seguido te presentás.',
    step3_title: 'Finanzas — cada peso cuenta',
    step3_desc: 'Ingresos y gastos por categoría. Cuando entra plata, la app te propone separar el 10% para inversión. Al final del mes tenés el análisis completo.',
