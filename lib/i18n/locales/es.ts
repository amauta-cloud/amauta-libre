export const es = {
  ...
  onboarding: {
    ...
    siguiente: 'Siguiente →',
    empezar: 'Arrancar',
    step0_title: 'Todo está acá',
    step0_desc: 'Hábitos, finanzas, metas, tareas — todo en un lugar. No tenés que tocar todo el primer día. Arrancá por lo que más te pica.',
    step1_title: 'El día, de un vistazo',
    step1_desc: 'Cada día marcás los hábitos que cumpliste y anotás lo que moviste en plata. Al cerrar ves cómo te fue. Sin vueltas.',
    step2_title: 'Los hábitos son tuyos',
    step2_desc: 'Hay plantillas para arrancar rápido. Si querés sumar los tuyos, los creás vos: con días específicos, meta numérica y la categoría que quieras.',
    step3_title: 'Tareas e ideas',
    step3_desc: 'En Planificación guardás tareas con fecha y las ideas sueltas que se te ocurren. En Aprendizaje hay 11 pasos para trabajar tu mentalidad.',
    step4_title: 'Tu meta, siempre a la vista',
    step4_desc: 'Lo que escribiste aparece todos los días. En los días difíciles, es lo que te recuerda por qué arrancaste.',
    step5_title: 'Tu plata, con orden',
    step5_desc: 'Registrás ingresos y gastos por categoría. Si entra plata, la app te propone apartar el 10% como inversión. Al mes, ves adónde fue cada peso.',
  },
}
