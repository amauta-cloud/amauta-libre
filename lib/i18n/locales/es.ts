export const es = {
  ...
  onboarding: {
    ...
    siguiente: 'Siguiente →',
    empezar: 'Arrancar',
    step0_title: 'Tu tablero',
    step0_desc: 'Todo lo que vas a trabajar está acá: hábitos, finanzas, metas, tareas. El primer día no tenés que tocar todo. Empezá por lo que más te pica.',
    step1_title: 'La pestaña Hoy es tu base',
    step1_desc: 'Acá marcás lo que cumpliste, anotás ingresos y gastos, y ves cómo cerró el día. No tiene que ser perfecto. Tiene que ser tuyo.',
    step2_title: 'Los hábitos son tuyos',
    step2_desc: 'Hay plantillas listas, pero podés agregar los que vos querés trabajar. El sistema se amolda a lo que necesitás, no al revés.',
    step3_title: 'Dos accesos rápidos arriba',
    step3_desc: 'Tus tareas e ideas están en Planificación. Los libros y audios del camino, en Educación. Avanzás cuando querés, al ritmo que podés.',
    step4_title: 'Tu meta, siempre a la vista',
    step4_desc: 'Lo que escribiste aparece acá todos los días. No para presionarte. Para que en los días difíciles no pierdas de vista para qué lo estás haciendo.',
  },
}
